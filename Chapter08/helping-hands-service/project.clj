(defproject helping-hands-service "0.0.1-SNAPSHOT"
  :description "Helping Hands Service Application"
  ...
  :main ^{:skip-aot true} helping-hands.service.server)
