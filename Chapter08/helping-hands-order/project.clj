(defproject helping-hands-order "0.0.1-SNAPSHOT"
  :description "Helping Hands Order Application"
  ...
  :main ^{:skip-aot true} helping-hands.order.server)
