(ns helping-hands.order.service
  (:require [helping-hands.order.core :as core]
            [cheshire.core :as jp]
...
(def routes #{["/orders/:id"
              ...
              ["/orders"
               :get (conj common-interceptors `auth `core/validate-all-orders
              ...
              ["/orders/:id"
               :delete (conj common-interceptors `auth `core/validate-id-get
